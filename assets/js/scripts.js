$(document).ready(function() {
  ...
  var artist = 'Picasso';
  let queryURL =
    'https://api.collection.cooperhewitt.org/rest/?method=cooperhewitt.people.getObjects&access_token=' +
    token +
    '&person=' +
    artist;
  ...
  dbRef.on('value', function(snapshot) {
    ...
    function totalDisplay(i) {
      ...
      infoCard =
        artist + '<br>' + acquired + '<br>' + medium + '<br>' + info + '</p>';
